  ...
  return (
    <div className="policy-container">
      ...
      <p>
        ...
        <strong>ECOMMERCE SHOPPING PRIVATE LTD</strong>, whose
        registered/operational office is{" "}
        <em>
          EXAMPLE ADDRESS
        </em>
        . The terms <strong>"you", "your", "user", "visitor"</strong> shall mean
        any natural or legal person who is visiting our website and/or has
      ...
      <h2>8. Linking to Our Site</h2>
      <p>
        You may not create a link to our website from another website or
        document without ECOMMERCE SHOPPING PRIVATE LTD’s prior written consent.
      </p>
